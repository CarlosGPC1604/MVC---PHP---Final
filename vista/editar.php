    ...
    <div class="bg-white p-8 rounded-lg shadow-md w-96">
        ...
        <form method="post" action="index.php?accion=actualizar">
            ...
            <div class="mb-4">
                ...
                <input type="text" autocomplete="off" id="nombre" name="nombre" value="<?php echo $producto['nombre']; ?>" required
                    class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400">
            </div>
            <div class="mb-6">
                <label for="precio" class="block text-gray-700">Precio:</label>
                <input type="number" autocomplete="off" id="precio" name="precio" value="<?php echo $producto['precio']; ?>" required step="0.01"
                    class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400">
            </div>
